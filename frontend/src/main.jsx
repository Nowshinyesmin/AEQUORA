...
import AuthorityNotification from "./pages/AuthorityNotification/AuthorityNotification.jsx";
  ...
  <StrictMode>
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/authority/notifications" element={<AuthorityNotification />} />
